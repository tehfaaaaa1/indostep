...
const classes = computed(() => {
    return props.active
        ...
        : 'inline-flex items-center px-4 py-3 text-sm leading-5 tracking-wider text-black-green hover:text-dark-green hover:bg-gray-200 font-medium transition duration-150 ease-in-out';
});
</script>
